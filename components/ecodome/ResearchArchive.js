...
<<<<<<< HEAD
  {
    title: 'Assessing the Environmental Safety of Recycled HDPE in Marine Conservation Applications',
    category: 'Marine Conservation',
    author: 'Arya Umrikar',
    description:
      'A research analysis examining recycled HDPE durability, ecological safety, microplastic risks, and its potential use in sustainable marine conservation infrastructure.',
    file: '/docs/marine-conservation-hdpe.pdf',
  },
  {
    title: 'Role of Mangrove Forests on Sequestration of CO₂ in the Atmosphere',
    category: 'Blue Carbon Research',
    author: 'Yatika Shah',
    description:
      'A study exploring how mangrove ecosystems capture atmospheric carbon dioxide, store blue carbon, and contribute to climate change mitigation strategies.',
    file: '/docs/mangrove-carbon-sequestration.pdf',
  },
  {
    title: 'Blue Carbon Dynamics and Accelerated Restoration Using HDPE Substrate Stabilization Frameworks',
    category: 'EcoDome Framework',
    author: 'Mohammed Fawwaz',
    description:
